...
export default async function UserProfilePage({
  ...
  const winRate = user.matchesPlayed === 0 ? 0 : Math.round((user.wins / user.matchesPlayed) * 100)

  return (
    <div className="mx-auto max-w-4xl space-y-8">
      <Link href="/rankings" className="inline-flex items-center gap-2 text-slate-400 hover:text-slate-200">
