    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div>
          ...
          <input name="maxParticipants" type="number" defaultValue={initial.maxParticipants} min={2} className="w-full rounded-lg border border-slate-600 bg-slate-800 px-4 py-2 text-slate-100" />
        </div>
      </div>
      <div>
