...
import { Calendar, PencilLine, ShieldCheck, Trophy, X } from "lucide-react";
import {
  CartesianGrid,
  Line,
  LineChart,
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        {editing ? (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-slate-600 px-3 py-2 text-sm text-slate-200 hover:bg-slate-800"
          >
            <X className="h-4 w-4" />
            取消编辑
          </button>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-cyan-500 to-blue-500 px-4 py-2 text-sm font-semibold text-white"
          >
