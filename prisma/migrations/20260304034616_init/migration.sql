...
-- CreateEnum
CREATE TYPE "CompetitionFormat" AS ENUM
('group_only', 'group_then_knockout');

-- CreateEnum
CREATE TYPE "RegistrationRole" AS ENUM
...
('earn', 'spend', 'adjustment', 'refund');

-- CreateEnum
CREATE TYPE "RewardType" AS ENUM
('physical', 'digital', 'coupon');
...
(
    ...
    "resultVerifiedAt" TIMESTAMP
    (3),
    "verifierId" TEXT,
    "createdAt" TIMESTAMP
    (3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "MatchResult_pkey" PRIMARY KEY
    ("id")
);
    ...
    -- AddForeignKey
    ALTER TABLE "RewardRedemption" ADD CONSTRAINT "RewardRedemption_rewardId_fkey" FOREIGN KEY ("rewardId") REFERENCES "Reward"("id")
